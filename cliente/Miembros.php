            ...
            <div class="topbar">
                ...
                <div class="search">
                    <form method="GET" action="">
                        <label>
                            <input type="text" class="input-control" placeholder="Buscar por nombre" name="search"
                    ...
                    <tbody>
                        ...
                        while ($datos = mysqli_fetch_assoc($con)) {
                            ...
                            <tr class="<?php echo $clase_fila; ?>">
                                ...
                                <td>
                                    <button type="button" class="btn-dark" onclick="openModal('exampleModaledit')"
                                    ...
                                    <button type="button" class="btn-warning" onclick="openModal('renovarModal')"
                                        data-id="<?php echo $datos['ID_Membresia']; ?>"
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="../servidor/renovar_membresia.php">
                        ...
                        <div class="fechaM">
                            ...
                            <input placeholder="Fecha de inicio" class="input" type="date" id="fecha_inicio"
                        ...
                        <div>
                            ...
                            <input type="number" id="cantidad" name="cantidad" placeholder="Número"
