...
<body>
    <div class="header">
        <img src="img/logo.jpeg" alt="Dragon GYM Logo" class="logo">
        <h1>Dragon GYM Inventario</h1>
    </div>
    ...
    <div class="filter-container">
        <form method="GET" action="inventario.php">
            ...
            <button type="reset" id="resetBtn" onclick="window.location.href='inventario.php';">Resetear filtros</button>
        </form>
    </div>

    <button class="insert-btn" onclick="document.getElementById('insertModal').style.display='block'">Insertar nuevo producto</button>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    while ($fila = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo "<td><img src='../servidor/img_inventario/{$fila['Foto']}' alt='Foto de producto' width=80 class='product-imagei'></td>";
    ...
    <div id="insertModal" class="modal">
        <div class="modal-content">
            <span onclick="document.getElementById('insertModal').style.display='none'" class="close-btn">&times;</span>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            <span onclick="document.getElementById('editModal').style.display='none'" class="close-btn">&times;</span>
